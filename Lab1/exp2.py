...
#The fit method is used to compute the imputation strategy based 
# on the provided data X

imputer=imputer.fit(df)

#The transform method is used to apply the imputation strategy 
#learned during the fit phase to fill in the missing values in 
#the input data X.
